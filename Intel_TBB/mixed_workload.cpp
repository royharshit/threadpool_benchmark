...
#include <time.h>
#include <stdint.h>
#include <tbb/tbb.h> // Include Intel TBB header
#include <iostream>
#include <chrono>
...
int main(int argc, char* argv[]) {
    ...
    // Step 3: Sort chunks of the file in parallel using TBB
    tbb::parallel_for(0, NUMBERS_TO_GENERATE / CHUNK_SIZE, 1, [](int chunk_number) {
        sort_chunk(chunk_number);
    });
